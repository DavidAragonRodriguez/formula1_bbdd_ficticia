Public Class AgenteBD
    ...
    Private Const cadenaConexion As String = "server=localhost;database=formulauno;uid=root;pwd=root"
    ...
    Public Function Modificar(sql As String) As Integer
        ...
        Conectar()
        result = com.ExecuteNonQuery ' Devuelve el número de filas afectadas por una instrucción SQL
        Desconectar()
        Return result
    End Function
